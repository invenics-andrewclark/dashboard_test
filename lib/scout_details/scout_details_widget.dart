...
import 'scout_details_model.dart';
export 'scout_details_model.dart';

class ScoutDetailsWidget extends StatefulWidget {
  const ScoutDetailsWidget({
    Key? key,
    this.scoutdetailpage,
    this.workerdetailpage,
    this.cappicc,
  }) : super(key: key);

  final CaptainsRecord? scoutdetailpage;
  final CaptainsRecord? workerdetailpage;
  final CaptainsRecord? cappicc;

  @override
  _ScoutDetailsWidgetState createState() => _ScoutDetailsWidgetState();
}

class _ScoutDetailsWidgetState extends State<ScoutDetailsWidget> {
  late ScoutDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScoutDetailsModel());
