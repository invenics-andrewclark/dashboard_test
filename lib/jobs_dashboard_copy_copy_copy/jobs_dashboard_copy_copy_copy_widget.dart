...
import 'jobs_dashboard_copy_copy_copy_model.dart';
export 'jobs_dashboard_copy_copy_copy_model.dart';

class JobsDashboardCopyCopyCopyWidget extends StatefulWidget {
  const JobsDashboardCopyCopyCopyWidget({
    Key? key,
    this.jobdetails,
  }) : super(key: key);
  ...
  @override
  _JobsDashboardCopyCopyCopyWidgetState createState() =>
      _JobsDashboardCopyCopyCopyWidgetState();
}

class _JobsDashboardCopyCopyCopyWidgetState
    extends State<JobsDashboardCopyCopyCopyWidget> {
  late JobsDashboardCopyCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JobsDashboardCopyCopyCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<JobsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<JobsRecord> jobsDashboardCopyCopyCopyJobsRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final jobsDashboardCopyCopyCopyJobsRecord =
            jobsDashboardCopyCopyCopyJobsRecordList.isNotEmpty
                ? jobsDashboardCopyCopyCopyJobsRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      if (jobsDashboardCopyCopyCopyJobsRecord!
                                              .endDate! >
                                          getCurrentTimestamp)
                                        Container(
                                          width: 250.0,
                                          ...
                                          child: SwitchListTile(
                                            ...
                                            onChanged: (newValue) async {
                                              ...
                                              if (!newValue!) {
                                                ...
                                                await jobsDashboardCopyCopyCopyJobsRecord!
                                                    .reference
                                                    .update(jobsUpdateData);
                                                setState(() {
                                                  FFAppState().jobstatusname =
                                                      'Closed';
                                                });
                                              }
                                            },
                                                                                                  ...
                                                                                                  child: Row(
                                                                                                    ...
                                                                                                    children: [
                                                                                                      Expanded(
                                                                                                        child: Builder(
                                                                                                          builder: (context) {
                                                                                                            final appliedworkers = widget.jobdetails!.applications!.toList().where((e) => e.applicationStatus == 0).toList();
                                                                                                      ...
                                                                                                      Expanded(
                                                                                                        child: Builder(
                                                                                                          builder: (context) {
                                                                                                            final acceptedworkers = widget.jobdetails!.applications!.toList().where((e) => e.applicationStatus == 1).toList();
                                                                                                      ...
                                                                                                      Expanded(
                                                                                                        child: Builder(
                                                                                                          builder: (context) {
                                                                                                            final rejectedworkers = widget.jobdetails!.applications!.toList().where((e) => e.applicationStatus == 2).toList();
