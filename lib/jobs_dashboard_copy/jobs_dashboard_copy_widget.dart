...
import 'jobs_dashboard_copy_model.dart';
export 'jobs_dashboard_copy_model.dart';

class JobsDashboardCopyWidget extends StatefulWidget {
  const JobsDashboardCopyWidget({
    Key? key,
    this.jobdetails,
  }) : super(key: key);
  ...
  @override
  _JobsDashboardCopyWidgetState createState() =>
      _JobsDashboardCopyWidgetState();
}

class _JobsDashboardCopyWidgetState extends State<JobsDashboardCopyWidget> {
  late JobsDashboardCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JobsDashboardCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<JobsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<JobsRecord> jobsDashboardCopyJobsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final jobsDashboardCopyJobsRecord =
            jobsDashboardCopyJobsRecordList.isNotEmpty
                ? jobsDashboardCopyJobsRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
