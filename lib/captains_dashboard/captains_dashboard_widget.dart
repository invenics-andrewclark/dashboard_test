...
import 'captains_dashboard_model.dart';
export 'captains_dashboard_model.dart';

class CaptainsDashboardWidget extends StatefulWidget {
  const CaptainsDashboardWidget({Key? key}) : super(key: key);

  @override
  _CaptainsDashboardWidgetState createState() =>
      _CaptainsDashboardWidgetState();
}

class _CaptainsDashboardWidgetState extends State<CaptainsDashboardWidget> {
  late CaptainsDashboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CaptainsDashboardModel());
                                                                                      ...
                                                                                      onPressed: () async {
                                                                                        context.pushNamed(
                                                                                          ...
                                                                                          extra: <String, dynamic>{
                                                                                            'captaindetails': listViewCaptainsRecord,
                                                                                          },
                                                                                        );
                                                                                      },
                                                                                    ),
