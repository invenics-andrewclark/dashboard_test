...
class EditCapatainProfileWidget extends StatefulWidget {
  ...
  final CaptainsRecord? editCaptain;
...
class _EditCapatainProfileWidgetState extends State<EditCapatainProfileWidget> {
  ...
  void initState() {
    ...
    _model.recruitmentAreaController ??=
        TextEditingController(text: widget.editCaptain!.recruitmentArea);
    _model.refferalController ??=
        TextEditingController(text: widget.editCaptain!.referralCode);
    _model.workerAdhaarNumberController ??=
                                  ...
                                  if (FFAppState().pass == '0') {
                                    ...
                                    if ((_model
                                      ...
                                      final captainsUpdateData1 =
                                        ...
                                        pinCode: _model.editaddressCaptainModel
                                        ...
                                        recruitmentArea: _model
                                            .recruitmentAreaController.text,
                                        tag: 'Captain',
                                      ...
                                      context.pushNamed('CaptainsDashboard');
