...
import 'add_skills_exp_model.dart';
export 'add_skills_exp_model.dart';

class AddSkillsExpWidget extends StatefulWidget {
  const AddSkillsExpWidget({
    Key? key,
    this.workerRef,
    this.workerDoc,
  }) : super(key: key);
  ...
  final DocumentReference? workerDoc;

  @override
  _AddSkillsExpWidgetState createState() => _AddSkillsExpWidgetState();
}

class _AddSkillsExpWidgetState extends State<AddSkillsExpWidget>
    with TickerProviderStateMixin {
  late AddSkillsExpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddSkillsExpModel());
      ...
      appBar: AppBar(
        ...
        title: Text(
          FFLocalizations.of(context).getText(
            '9dix1hhl' /* Add Skills & Experience */,
          ),
