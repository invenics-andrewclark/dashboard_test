...
class _EditaddressCaptainWidgetState extends State<EditaddressCaptainWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<CaptainsRecord>(
      stream: CaptainsRecord.getDocument(FFAppState().editcaptainaddress!),
      builder: (context, snapshot) {
        ...
        final containerCaptainsRecord = snapshot.data!;
        return Container(
          width: 700.0,
          height: 540.0,
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.pincodefieldController ??=
                                  ...
                                  text: containerCaptainsRecord.pinCode,
                                ),
                              ...
                              valueOrDefault<String>(
                                () {
                                  if (FFAppState().disabling == '2') {
                                    return containerCaptainsRecord.district;
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              valueOrDefault<String>(
                                () {
                                  if (FFAppState().disabling == '2') {
                                    return containerCaptainsRecord.state;
                                  } else if (FFAppState().disabling == '1') {
