                              ...
                              SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    StreamBuilder<List<JobContractsRecord>>(
                                      stream: queryJobContractsRecord(
                                        parent: widget.organisationRef,
                                        queryBuilder: (jobContractsRecord) =>
                                            jobContractsRecord.orderBy(
                                                'start_date',
                                                descending: true),
                                      ),
                                      builder: (context, snapshot) {
                                        ...
                                        List<JobContractsRecord>
                                            listViewJobContractsRecordList =
                                            snapshot.data!;
                                        if (listViewJobContractsRecordList
                                            .isEmpty) {
                                          return Center(
                                            child: Container(
                                              width: MediaQuery.of(context)
                                        ...
                                        return ListView.builder(
                                          ...
                                          itemBuilder:
                                            ...
                                            final listViewJobContractsRecord =
                                                listViewJobContractsRecordList[
                                                    listViewIndex];
                                            return Container(
                                              width: double.infinity,
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: Text(
                                                                                listViewJobContractsRecord.workerGender!,
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Padding(
                                                                              padding: EdgeInsetsDirectional.fromSTEB(2, 0, 0, 0),
                                                                              child: Text(
                                                                                listViewJobContractsRecord.workerSkill!,
                                                                                style: FlutterFlowTheme.of(context).bodyText2.override(
                                                                                      fontFamily: FlutterFlowTheme.of(context).bodyText2Family,
                                                                                      color: FlutterFlowTheme.of(context).primaryColor,
                                                                                      fontWeight: FontWeight.w600,
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Padding(
                                                                              padding: EdgeInsetsDirectional.fromSTEB(2, 0, 0, 0),
                                                                              child: Text(
                                                                                listViewJobContractsRecord.workerSkillExperience!,
                                                                                style: FlutterFlowTheme.of(context).bodyText2.override(
                                                                                      fontFamily: FlutterFlowTheme.of(context).bodyText2Family,
                                                                                      color: FlutterFlowTheme.of(context).primaryColor,
                                                                                      fontWeight: FontWeight.w600,
